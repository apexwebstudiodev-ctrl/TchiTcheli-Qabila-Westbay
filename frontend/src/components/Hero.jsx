...
export const Hero = () => {
  ...
  const drift = useTransform(scrollYProgress, [0, 1], ["0%", "35%"]);

  return (
    <section id="top" ref={ref} data-testid="hero-section" className="group relative flex min-h-screen items-end overflow-hidden">
      <motion.img
        src={IMAGES.hero.url}
        alt={IMAGES.hero.alt}
      ...
      <motion.div style={{ opacity: fade, y: drift }} className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-24 pt-40 lg:px-12">
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl">
          ...
          <motion.p variants={item} data-testid="hero-subtext" className="mt-8 max-w-xl text-base leading-relaxed text-white/70 md:text-lg">
