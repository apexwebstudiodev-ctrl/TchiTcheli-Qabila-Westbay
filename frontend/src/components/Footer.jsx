...
export const Footer = () => {
  ...
  const marqueeX = useTransform(scrollYProgress, [0, 1], ["6%", "-6%"]);

  return (
    <footer ref={ref} data-testid="site-footer" className="border-t border-white/10 bg-[#08090C]">
      <div className="mx-auto max-w-7xl px-6 pb-12 pt-24 lg:px-12 lg:pt-32">
            ...
            <div className="mt-12 space-y-6">
              ...
              <Reveal delay={0.26}>
                <div className="flex items-center gap-4" data-testid="footer-hours">
                  ...
                  <span className="text-base text-white/70">Open 24 hours — 7 days a week</span>
                </div>
              </Reveal>
        ...
        <div className="mt-24 select-none overflow-hidden" aria-hidden="true">
          <motion.p
            style={{ x: marqueeX }}
            className="whitespace-nowrap text-center font-display text-[13vw] font-black leading-none tracking-tight text-white/[0.05]"
          >
            TCHI TCHI
          </motion.p>
        </div>
